...
def main(args: tuple[str, ...]) -> None:
    def _fallback_refresh(repo_root: Path) -> None:
        ...
        pipeline.USER_CONTEXT_FILE = pipeline.PIPELINE_DIR / "user_context.md"
        pipeline.BRAINSTORM_CONTEXT_FILE = pipeline.PIPELINE_DIR / "brainstorm_context.md"
        pipeline.TASK_REVIEW_FEEDBACK_FILE = pipeline.PIPELINE_DIR / "task_review_feedback.md"
